"""
A/B Testing Suite for ProcessingAgent Comparison (integration)

This file contains integration-style A/B comparison tests. It was migrated out
of `tests/unit/` because it exercises end-to-end behavior, performance, and
