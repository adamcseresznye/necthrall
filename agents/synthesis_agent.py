...
CITATION_QA_TEMPLATE = (
    ...
    "   - **GRANULAR CITATION**: \n"
    "       * **Rule:** Cite the source [x] *immediately* after the specific statistic it supports.\n"
    ...
    "   - **VERIFICATION**: Ensure the source [x] *actually contains* the specific number attached to it.\n\n"
    "5. **START IMMEDIATELY**: \n"
